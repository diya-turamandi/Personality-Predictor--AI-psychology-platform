...
_Generated: 2026-05-27T02:56:10.355Z_
...
Workspace `mcp.json` _(folder: ai)_

- **c:\ai\.vscode\mcp.json** — _File missing_

_No active workspace servers in mcp.json._

## MCP — user profile

- **C:\Users\diyat\AppData\Roaming\Code\User\mcp.json** — _File exists — servers defined_

| Server id | Kind | Detail |
|-----------|------|--------|
| github | http | https://api.githubcopilot.com/mcp/ |
| figma | http | http://127.0.0.1:3845/sse |
