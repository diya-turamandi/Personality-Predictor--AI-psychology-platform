...
_Last synced: 2026-05-27T02:56:10.684Z._
...
- `c:\ai\.vscode\mcp.json` _(workspace: ai)_ — _file missing_

_No active workspace servers in mcp.json._

#### User MCP

- `C:\Users\diyat\AppData\Roaming\Code\User\mcp.json` — _servers defined_
